...
const Hero = () => {
    ...
    //     })
    //     console.log(`useEffect: ${isIntersecting}`)
  ...
  return (
    <content ref={scrollEf} className='px-[6%] min-[320px]:max-sm:py-0 min-[320px]:max-sm:px-5 oveflow-clip'>
        <div className={`flex flex-row items-center min-[320px]:max-sm:justify-end mb-20 min-[320px]:max-sm:mb-10 transition-all duration-500 ${isIntersecting ? `translate-x-0 opacity-100` : `-translate-x-[300px] opacity-0`}`}>
        ...
        <div className='flex flex-row min-[320px]:max-sm:flex-col w-full min-[320px]:max-sm:gap-10 justify-between'>
            <div className={`flex flex-col font-unbounded transition-all duration-500 ${isIntersecting ? `translate-x-0 opacity-100` : `-translate-x-[300px] opacity-0`}`}>
                <div>
            ...
            <div className={`w-1/6 min-[320px]:max-sm:w-4/6 flex flex-col gap-6 justify-end transition-all duration-500 ${isIntersecting ? `translate-x-0 opacity-100` : `translate-x-[300px] opacity-0`}`}>
