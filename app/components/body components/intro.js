...
const Intro = () => {
  return (
    <section className='w-full grid grid-cols-3 min-[320px]:max-md:flex min-[320px]:max-md:flex-col'>
        <div className='col-span-2 flex flex-col gap-12'>
            ...
            <h1 className='font-unbounded text-6xl min-[320px]:max-sm:text-4xl sm:max-md:leading-loose leading-relaxed font-light bg-gradient-to-r from-[#C6F1F7] via-[#F983E9] via-25% to-[#B877FF] inline-block text-transparent bg-clip-text'>
        ...
        <div className='flex flex-col justify-self-end self-end justify-center items-center bg-[#202020] w-3/5 h-3/6 md:max-xl:h-72 min-[320px]:max-md:hidden p-5'>
